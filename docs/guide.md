...
@sourceref node_modules/donejs-chat-guide/steps/4-bootstrap/index.stache
@highlight 8,12-22
...
@sourceref node_modules/donejs-chat-guide/steps/7-navigate/home.component
@highlight 4,7-16
...
@sourceref node_modules/donejs-chat-guide/steps/7-navigate/messages.stache
@highlight 1

Then, add a routing rule for the `page` property in `src/app.js`:

@sourceref node_modules/donejs-chat-guide/steps/7-navigate/app.js
@highlight 15
...
@sourceref node_modules/donejs-chat-guide/steps/7-navigate/index.stache
@highlight 15-31
...
@sourceref node_modules/donejs-chat-guide/steps/8-bit-tabs/home.component
...
@sourceref node_modules/donejs-chat-guide/steps/10-use-connection/messages.stache
@highlight 1,4-15
...
@sourceref node_modules/donejs-chat-guide/steps/11-create-messages/messages.stache
@highlight 17-29

Next we have to implement the `send()` method. Update `src/messages/messages.js` to this:

@sourceref node_modules/donejs-chat-guide/steps/11-create-messages/messages.js
@highlight 6,9-15
...
@sourceref node_modules/donejs-chat-guide/steps/12-real-time/message.js
@highlight 5,25-32
...
@sourceref node_modules/donejs-chat-guide/steps/15-cdn/deploy.json
